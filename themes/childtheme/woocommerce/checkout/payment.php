...
<div id="payment" class="woocommerce-checkout-payment">
	<?php if ( WC()->cart->needs_payment() ) : ?>
		<ul class="wc_payment_methods payment_methods methods custom-ul" style="flex-wrap: unset !important; max-width: 100% !important;">
			<?php
	...
	<?php if ( WC()->cart->needs_payment() ) : ?>
			...
			<?php
				if ( ! empty( $available_gateways ) ) {
					foreach ( $available_gateways as $gateway ) {
						wc_get_template( 'checkout/payment-container.php', array( 'gateway' => $gateway ) );
					}
				} else {
