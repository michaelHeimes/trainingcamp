...
<?php while(have_posts()): the_post(); ?>
    ...
    $background_url = ($background_url) ?: get_template_directory_uri() . '/slice/dist/images/home-bg-4.png';
    ...
    <div class="ROCKETslider">
         <?php 
echo do_shortcode('[smartslider3 slider=46]');
?>
    </div>
             <!-- HIDE THE CONTENT BLOCK
    <div class="top-bg home-bg">
