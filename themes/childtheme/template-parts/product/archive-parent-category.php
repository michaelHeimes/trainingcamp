...
?>
<!--<div class="top-bg featured page-heading"
     style="background-image: url('<?= $background ?>');">
    <div class="content-block custom-content-block">
        <h1 class="word-capitalize"><?= get_field('training_title','options') ?></h1>
...
<div class="section  custom-section">
    ...
    <?php if(is_array($terms) && count($terms)>0): ?>
        ...
        <div class="container course-container-title">
	   <div class="title">
                <h2><?= get_field('training_title','options') ?></h2>
            </div>
            <div class="title custom-title">
                <h2>browse courses</h2>
            </div>
            <div class="tab-nav custom-tab-nav">
                <ul class="custom-ul" style="width: 100% !important;">
...
<li class="product-item custom-product-item">
    <a id="professional-dev1" class="tile professional-dev custom-professional-dev" href="<?= get_term_link($category->term_id) ?>">
                    <div class="content">
                        <h3 class="heading custom-course-heading"><?= $category->name ?></h3>
                        <div class="rollover custom-catgory-rollover">
                         <!--   <p class="descr custom-descr"> <?= $category->description ?> </p> -->
                           <!-- <p class="text-link">View training subscriptions <span class="icon icon-arrow-right"></span></p> -->
                        </div>
                    </div>
                </a>
                        </li>
