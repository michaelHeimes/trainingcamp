<div class="columns container content custom-include-container">
    <div class="col">
...
<?php if(have_rows('product_include_as_seen_section')): ?>
        <section class="as-seen-on">
            <div class="container">
                <h4><?= get_field('product_include_as_seen_title') ?></h4>
                <ul>
                    <?php while(have_rows('product_include_as_seen_section')): the_row(); ?>
                        <?php
                        $icon=get_sub_field('product_include_as_seen_icon');
...
if($description):
    ?>
    <div class="certificate section  custom-certificate-section">
        <div class="container">
...
<div class="container">
    ...
    <?php endif; ?>
    <div class="buttons aligncenter" style="display:none !important;">
