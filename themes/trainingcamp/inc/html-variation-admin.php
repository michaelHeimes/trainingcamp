...
<div class="woocommerce_variation wc-metabox closed">
	<h3>
		...
		<?php if ($start_date): ?>
			<span><b>Start date: </b><span style="font-weight: 100; color:#0073aa"><?= $start_date ?></span></span>
		<?php endif; ?>
		<?php if ($end_date): ?>
			<span style="padding-left: 10px;"><b>End date: </b><span style="font-weight: 100"><?= $end_date ?></span></span>
		<?php endif; ?>
